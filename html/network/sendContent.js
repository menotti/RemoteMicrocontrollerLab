...
function savefiles () {
	var cpp_content = document.getElementById("m").value;
	...
	request.open('POST', '/network/save_contents.php', true); //request a "POST" method request to the server to open the file
